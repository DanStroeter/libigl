...
void somig_deformer_3::precompute_mvc_coords() {
  ...
  clk.stop();
  spdlog::info("MVC comp time={}", clk.duration()/1000.0);
...
void somig_deformer_3::precompute_somig_coords() {
  ...
  spdlog::info("SOMIG comp time={}", clk.duration()/1000.0);
...
void somig_deformer_3::deform(matd_t             &V,
  ...
  if ( typeDf == SOMIGLIANA ) {
    ...
    clk.stop();
    cout << "# editing time=" << clk.duration()/1000.0 << endl;
